...
function RouteComponent() {
  ...
  const componentTrigger =
    viewMode === "table" ? (
      ...
      <div className="flex h-60 w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-white p-4 shadow-md shadow-zinc-600 transition-all duration-500 hover:cursor-pointer hover:shadow-xl md:w-1/3 lg:w-1/4 xl:max-w-100 dark:bg-sidebar-950 dark:shadow-zinc-900">
