...
export const en: Translations = {
  ...
  errors: {
    ...
    unknownError: "Unknown error",
    loadingProject: "Error loading enterprise",
  },
  sidebar: {
    about: "About BIPc",
    learnMore: "Learn more",
  ...
  projects: {
    title: "Enterprises",
    add: "Add Enterprise",
    deleteSuccess: "Enterprise deleted successfully",
    deleteError: "Error deleting enterprise",
    duplicateTitle: "Duplicate Enterprise",
    duplicateContent:
      "Are you sure you want to duplicate this enterprise? This action will create an identical copy of the enterprise, including all its information and settings. You can edit the details of the new enterprise after duplication.",
    duplicateConfirm: "Duplicate",
    duplicateSuccess: "Enterprise duplicated successfully",
    duplicateError: "Error duplicating enterprise",
    table: {
      name: "Name",
      description: "Description",
      createdAt: "Created at",
      updatedAt: "Updated at",
      deleteTitle: "Delete Enterprise",
    },
    form: {
      ...
      siop: "SIOP",
      siopPlaceholder: "Enter SIOP",
      apf: "APF",
      apfPlaceholder: "Enter APF",
      cep: "ZIP Code",
      ...
      description: "Description",
      descriptionPlaceholder: "Describe the enterprise...",
      editButton: "Update Enterprise",
      addButton: "Add Enterprise",
      createSuccess: "Enterprise created successfully",
      createError: "Error creating enterprise",
    ...
    projectTransfer: {
      ...
      warning: {
        ...
        point2: "The new owner will have full control of the enterprise",
      ...
      newOwnerMessage: "You must have at least one collaborator in the enterprise to transfer ownership.",
      collaboratorLink: "Add collaborators here.",
      transferSuccess: "Ownership transferred successfully!",
      transferSuccessDescription: "You are no longer the administrator of this enterprise.",
      transferError: "Error transferring ownership",
      transferErrorDescription: "An error occurred while transferring the ownership of the enterprise.",
      noUserSelectedError: "Select a collaborator",
      noUserSelectedErrorDescription: "You need to select a new owner.",
    },
    selectAll: "Select All",
    deselectAll: "Deselect All",
    noProjects: "You don't have any enterprises yet.",
    noProjectsDescription: "Create your first enterprise to start managing your units and simulations.",
  },
  units: {
  ...
  invites: {
    title: "Invitations",
    manage: "Manage your enterprise and collaboration invitations",
  ...
  user: {
    ...
    deleteAccountProjectsActive:
      "You have active enterprises. Please delete or transfer all enterprises before deleting your account.",
  ...
  drawer: {
    ...
    importantDescription:
      "Enterprise managers may be contacted up to 3 years after the end of the enterprise phase indicated at the time of enterprise creation. This contact seeks to confirm the execution of the data provided at the time of the enterprise. The reliability of our benchmark depends on your collaboration. Thank you for your understanding!",
    agreement:
      "I am aware of the possibility of being contacted to confirm the enterprise data, as informed",
  ...
  projectView: {
    ...
    noBuildingsDescription: "Define floors and units to organize the structure of this enterprise.",
  ...
  validators: {
    ...
    selectPhase: "Select an enterprise phase",
  ...
  summaryTechnologies: {
    enterprises: "Enterprises",
    noEnterpriseSelected: "No enterprise selected.",
    noEnterpriseDescription: "Please select at least one enterprise to view the summary.",
  },
  summaryFloors: {
    floors: "Floors",
  },
  ...
  unitView: {
    ...
    createFirstSimulationDescription: "Click the \"Create simulations\" button and add the enterprise data.",
    floors: "Floors",
  ...
  constructiveTechView: {
    ...
    createFirstSimulation: "Create your first simulation",
    createFirstSimulationDescription: "Click 'New Simulation' to add technical data and constructive technologies for this enterprise.",
    noTechFound: "No constructive technology found",
  ...
  disciplines: {
    ...
    permissionLabels: {
      updateProject: "Update enterprise",
