...
export default function DrawerAddModule({ componentTrigger, callback, curModule, context }: IDrawerAddProject) {
    ...
    <Drawer direction='right' open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DrawerContent className='min-w-2/5'>
        <DrawerHeader className='px-6'>
          <DrawerTitle>
            {context === 'simulation' ? t('simulations.addSimulation'):t('common.constructiveTechnology')}
          </DrawerTitle>
        </DrawerHeader>
          ...
          >
            {/* <div className='flex items-center justify-center'>
              <Button type='submit' variant='noStyles' className='w-full'>
                {context === 'simulation' ? t('simulations.addSimulation'):t('drawerAddModule.addConstructiveTechnology')}
              </Button>
            </div> */}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl className='w-full'>
                    <Select onValueChange={field.onChange} defaultValue={field.value} disabled={!!curModule}>
            ...
            <section className='my-4 flex w-full flex-col gap-2'>
              <p className='block w-full flex-1'>{t('drawerAddModule.numberOfFloors')}</p>
              <div className='grid grid-cols-2 items-end gap-4 pl-2'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('drawerAddModule.basementNumber')}</FormLabel>
                      <FormControl>
                        <Input type='number' {...field} />
                      </FormControl>
                      <FormMessage />
            ...
            <div className='grid grid-cols-2 items-end gap-4'>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.floorToFloorHeight')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.maxFloorToFloorHeight')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.concreteVolumeFck20')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.concreteVolumeFck25')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.concreteVolumeFck30')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.concreteVolumeFck35')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.concreteVolumeFck40')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.concreteVolumeFck45')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('drawerAddModule.steelConsumption')}</FormLabel>
                    <FormControl>
                      <Input type='number' step='0.01' {...field} />
                    </FormControl>
                    <FormMessage />
