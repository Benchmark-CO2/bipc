...
func (s *StructuralMasonry) Insert(models data.Models, optionID uuid.UUID, result Consumption, source string) (Module, error) {
	...
	s.normalizeToNewFormat()
	moduleToInsert := s.toDataModule(moduleID, optionID, result, source)
...
func (s *StructuralMasonry) Update(models data.Models, moduleID, optionID uuid.UUID, result Consumption, source string) error {
	s.normalizeToNewFormat()
	module := s.toDataModule(moduleID, optionID, result, source)
...
func (s *StructuralMasonry) toDataModule(moduleID, optionID uuid.UUID, result Consumption, source string) *data.Module {
